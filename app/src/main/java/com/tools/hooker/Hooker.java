...
public class Hooker {
    static class MethodReplacement extends XC_MethodReplacement {
        ...
        public MethodReplacement(FakeClassBase fakeObject, Method fakeMethod, Method originMethod, FakeMethod hookParams) throws Exception {
            ...
            this.staticHook = hookParams.staticHook();
        }
        ...
        protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
            try {
                ...
                boolean shouldFake = mustHook || this.fakeObject.ShouldFake(param);
                if (!shouldFake && !this.staticHook) {
    ...
    static public boolean HookClass(ClassLoader classLoader, Class fakeClass, FakeClassBase fakeInst) {
        try {
